...
echo -e "${BOLD}${CYAN}======================================================================"
echo -e "         Apigee LLM Gateway Claude Route Testing Script               "
echo -e "======================================================================${NC}"
...
for i in "${!test_cases[@]}"; do
  ...
  echo -e "\n${BOLD}${YELLOW}[Test $count/15] Sending to Claude - Type: $type${NC}"
...
EOF
  ...
  if [ "$http_code" -eq 200 ] || [ "$http_code" -eq 201 ]; then
    ...
    # Preview first 120 characters of response
...
echo -e "${CYAN}======================================================================${NC}"
echo -e "${BOLD}${GREEN}Testing Complete! All 15 test runs executed successfully.${NC}"
